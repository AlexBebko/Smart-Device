...
/* harmony import */ var _modules_modals_more__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/modals/more */ "./js/modules/modals/more.js");
/* harmony import */ var _modules_modals_scroll_to_block__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/modals/scroll-to-block */ "./js/modules/modals/scroll-to-block.js");
/* harmony import */ var _modules_modals_phone_mask__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/modals/phone-mask */ "./js/modules/modals/phone-mask.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  // ---------------------------------
  Object(_modules_modals_accordion__WEBPACK_IMPORTED_MODULE_6__["accordionWorking"])();
  Object(_modules_modals_phone_mask__WEBPACK_IMPORTED_MODULE_5__["makeMaskForPhoneInputs"])();
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_modals_modal__WEBPACK_IMPORTED_MODULE_2__["callEventListeners"])();
    Object(_modules_modals_more__WEBPACK_IMPORTED_MODULE_3__["openMoreText"])();
    Object(_modules_modals_scroll_to_block__WEBPACK_IMPORTED_MODULE_4__["scrollToBlock"])();
  });
});
...
/*!****************************************!*\
  !*** ./js/modules/modals/accordion.js ***!
  \****************************************/
/*! exports provided: accordionWorking */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "accordionWorking", function() { return accordionWorking; });
var accordionButtonElement = document.querySelectorAll('.main-footer__accordion-button');
var accordionElement = document.querySelectorAll('.main-footer__accordion-container');
function accordionWorking() {
  ...
  if (accordionButtonElement) {
    accordionButtonElement.forEach(function (item) {
      item.addEventListener('click', function () {
        var parent = item.parentNode;
        if (parent.classList.contains('is-closed')) {
          accordionElement.forEach(function (child) {
...
/*!************************************!*\
  !*** ./js/modules/modals/modal.js ***!
  \************************************/
/*! exports provided: callEventListeners */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "callEventListeners", function() { return callEventListeners; });
/* harmony import */ var _utils_is_key__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/is-key */ "./js/utils/is-key.js");

var bodyElement = document.querySelector('body');
var modalOpenButtonElement = document.querySelector('[data-modal-opens-button]');
var modalWindow = document.querySelector('[data-modal-window]');
var modalWindowElement = document.querySelector('[data-modal-block]');
var modalCloseButtonElement = document.querySelector('[data-modal-close-button]');
var modalInputNameElement = document.querySelector('[data-modal-name-input]');
function onModalOpenButtonClick() {
  openModalWindow();
}
function onModalOpenButtonEnterKeydown(evt) {
  if (Object(_utils_is_key__WEBPACK_IMPORTED_MODULE_0__["isEnterKey"])(evt)) {
    evt.preventDefault();
    openModalWindow();
  }
}
...
function onModalWindowEscapeKeydown(evt) {
  if (Object(_utils_is_key__WEBPACK_IMPORTED_MODULE_0__["isEscapeKey"])(evt)) {
    evt.preventDefault();
    closeModalWindow();
  }
}
function onOutsideModalClick(evt) {
  var isClickInside = modalWindowElement.contains(evt.target);
  if (!isClickInside) {
    closeModalWindow();
  }
}
function focusableModalWindow() {
  if (modalWindowElement) {
    var focusableElementsString = 'a[href], input:not([disabled]), textarea:not([disabled]), button:not([disabled]), [tabindex="0"]';
    var focusableElements = modalWindowElement.querySelectorAll(focusableElementsString);
    var unfocusableElementsString = '[tabindex="-1"]';
    var unfocusableElements = modalWindowElement.querySelectorAll(unfocusableElementsString);
...
/***/ "./js/modules/modals/more.js":
/*!***********************************!*\
  !*** ./js/modules/modals/more.js ***!
  \***********************************/
/*! exports provided: openMoreText */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "openMoreText", function() { return openMoreText; });
var moreButtonElement = document.querySelector('[data-hidden-text-button]');
var moreTextElement = document.querySelector('.about__text--more');
...
var anchorElement = document.querySelector('[data-scroll-to-form-button]');
